		...
		<!-- One -->
			<section id="One" class="wrapper style3">
				<div class="inner">
                    ...
                    <a href="upload2ece.php"><button >Do u want to upload a file</button></a>
					</header>
				</div>
			</section>
			...
			<div id="main" class="container">
				...
				<!-- Elements -->
					<h2 id="elements">Elements</h2>
								...
								<div class="table-wrapper"><!DOCTYPE HTML>
<!--
	Hielo by TEMPLATED
	templated.co @templatedco
	Released for free under the Creative Commons Attribution 3.0 license (templated.co/license)
	...
	<body class="subpage">
		...
		<!-- One -->
			<section id="One" class="wrapper style3">
				<div class="inner">
					<header class="align-center">
                    <a href="upload1ece.html"><button >Do u want to upload a file</button></a>
					</header>
				</div>
			</section>
...
$files_show= "fileuploadece/$files_field";
